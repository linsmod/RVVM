...
#ifndef VIRTPASS_GLEXT
#define VIRTPASS_GLEXT

/* The extension tokens without the core ones are meaningless, so this
 * header is self-sufficient rather than a fragment. */
#include "virtpass/vp_gl.h"

/* ============================================================
 * GLES extension symbolic constants
 *
 * 1504 tokens, parsed out of the NDK headers - nothing in here is
