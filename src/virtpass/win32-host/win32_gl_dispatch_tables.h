 ...
 * Guest data pointers are translated by the w32gl_gptr*() helpers
...
static void w32gl_dispatch_egl_generic(uint32_t fn_id, const int64_t* a, int64_t* ret)
{
    ...
    case EGL_FN_CREATEPBUFFERSURFACE:
        if (p_eglCreatePbufferSurface) { *ret = (int64_t)(intptr_t)((w32gl_PFN_eglCreatePbufferSurface)p_eglCreatePbufferSurface)((w32gl_void*)(uintptr_t)a[0], (w32gl_void*)(uintptr_t)a[1], (const w32gl_EGLint*)w32gl_gptr(a[2])); }
        break;
    case EGL_FN_CREATEWINDOWSURFACE:
        if (p_eglCreateWindowSurface) { *ret = (int64_t)(intptr_t)((w32gl_PFN_eglCreateWindowSurface)p_eglCreateWindowSurface)((w32gl_void*)(uintptr_t)a[0], (w32gl_void*)(uintptr_t)a[1], (w32gl_void*)(uintptr_t)a[2], (const w32gl_EGLint*)w32gl_gptr(a[3])); }
        break;
    ...
    case EGL_FN_GETCONFIGATTRIB:
        if (p_eglGetConfigAttrib) { *ret = (int64_t)(uint32_t)((w32gl_PFN_eglGetConfigAttrib)p_eglGetConfigAttrib)((w32gl_void*)(uintptr_t)a[0], (w32gl_void*)(uintptr_t)a[1], (w32gl_EGLint)a[2], (w32gl_EGLint*)w32gl_gptr(a[3])); }
        break;
    ...
    case EGL_FN_QUERYSTRING:
        if (p_eglQueryString) { *ret = w32gl_string_out(a, (const char*)((w32gl_PFN_eglQueryString)p_eglQueryString)((w32gl_void*)(uintptr_t)a[0], (w32gl_EGLint)a[1])); }
        break;
    case EGL_FN_QUERYSURFACE:
        if (p_eglQuerySurface) { *ret = (int64_t)(uint32_t)((w32gl_PFN_eglQuerySurface)p_eglQuerySurface)((w32gl_void*)(uintptr_t)a[0], (w32gl_void*)(uintptr_t)a[1], (w32gl_EGLint)a[2], (w32gl_EGLint*)w32gl_gptr(a[3])); }
        break;
...
static void w32gl_dispatch_gl_generic(uint32_t fn_id, const int64_t* a, int64_t* ret)
{
    ...
    case GL_FN_BINDATTRIBLOCATION:
        if (p_glBindAttribLocation) { ((w32gl_PFN_glBindAttribLocation)p_glBindAttribLocation)((w32gl_GLuint)a[0], (w32gl_GLuint)a[1], (const w32gl_GLchar*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_BUFFERDATA:
        if (p_glBufferData) { ((w32gl_PFN_glBufferData)p_glBufferData)((w32gl_GLenum)a[0], (w32gl_GLsizeiptr)a[1], (const w32gl_void*)w32gl_gptr(a[2]), (w32gl_GLenum)a[3]); }
        break;
    case GL_FN_BUFFERSUBDATA:
        if (p_glBufferSubData) { ((w32gl_PFN_glBufferSubData)p_glBufferSubData)((w32gl_GLenum)a[0], (w32gl_GLintptr)a[1], (w32gl_GLsizeiptr)a[2], (const w32gl_void*)w32gl_gptr(a[3])); }
        break;
    ...
    case GL_FN_COMPRESSEDTEXIMAGE2D:
        if (p_glCompressedTexImage2D) { ((w32gl_PFN_glCompressedTexImage2D)p_glCompressedTexImage2D)((w32gl_GLenum)a[0], (w32gl_GLint)a[1], (w32gl_GLenum)a[2], (w32gl_GLsizei)a[3], (w32gl_GLsizei)a[4], (w32gl_GLint)a[5], (w32gl_GLsizei)a[6], (const w32gl_void*)w32gl_gptr(a[7])); }
        break;
    case GL_FN_COMPRESSEDTEXSUBIMAGE2D:
        if (p_glCompressedTexSubImage2D) { ((w32gl_PFN_glCompressedTexSubImage2D)p_glCompressedTexSubImage2D)((w32gl_GLenum)a[0], (w32gl_GLint)a[1], (w32gl_GLint)a[2], (w32gl_GLint)a[3], (w32gl_GLsizei)a[4], (w32gl_GLsizei)a[5], (w32gl_GLenum)a[6], (w32gl_GLsizei)a[7], (const w32gl_void*)w32gl_gptr(a[8])); }
        break;
    ...
    case GL_FN_DELETEBUFFERS:
        if (p_glDeleteBuffers) { ((w32gl_PFN_glDeleteBuffers)p_glDeleteBuffers)((w32gl_GLsizei)a[0], (const w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_DELETEFRAMEBUFFERS:
        if (p_glDeleteFramebuffers) { ((w32gl_PFN_glDeleteFramebuffers)p_glDeleteFramebuffers)((w32gl_GLsizei)a[0], (const w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_DELETERENDERBUFFERS:
        if (p_glDeleteRenderbuffers) { ((w32gl_PFN_glDeleteRenderbuffers)p_glDeleteRenderbuffers)((w32gl_GLsizei)a[0], (const w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_DELETETEXTURES:
        if (p_glDeleteTextures) { ((w32gl_PFN_glDeleteTextures)p_glDeleteTextures)((w32gl_GLsizei)a[0], (const w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_DRAWELEMENTS:
        if (p_glDrawElements) { ((w32gl_PFN_glDrawElements)p_glDrawElements)((w32gl_GLenum)a[0], (w32gl_GLsizei)a[1], (w32gl_GLenum)a[2], (const w32gl_void*)w32gl_gptr_or_off(a[3])); }
        break;
    case GL_FN_ENABLE:
    ...
    case GL_FN_GENBUFFERS:
        if (p_glGenBuffers) { ((w32gl_PFN_glGenBuffers)p_glGenBuffers)((w32gl_GLsizei)a[0], (w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_GENFRAMEBUFFERS:
        if (p_glGenFramebuffers) { ((w32gl_PFN_glGenFramebuffers)p_glGenFramebuffers)((w32gl_GLsizei)a[0], (w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GENRENDERBUFFERS:
        if (p_glGenRenderbuffers) { ((w32gl_PFN_glGenRenderbuffers)p_glGenRenderbuffers)((w32gl_GLsizei)a[0], (w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GENTEXTURES:
        if (p_glGenTextures) { ((w32gl_PFN_glGenTextures)p_glGenTextures)((w32gl_GLsizei)a[0], (w32gl_GLuint*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETACTIVEATTRIB:
        if (p_glGetActiveAttrib) { ((w32gl_PFN_glGetActiveAttrib)p_glGetActiveAttrib)((w32gl_GLuint)a[0], (w32gl_GLuint)a[1], (w32gl_GLsizei)a[2], (w32gl_GLsizei*)w32gl_gptr(a[3]), (w32gl_GLint*)w32gl_gptr(a[4]), (w32gl_GLenum*)w32gl_gptr(a[5]), (w32gl_GLchar*)w32gl_gptr(a[6])); }
        break;
    case GL_FN_GETACTIVEUNIFORM:
        if (p_glGetActiveUniform) { ((w32gl_PFN_glGetActiveUniform)p_glGetActiveUniform)((w32gl_GLuint)a[0], (w32gl_GLuint)a[1], (w32gl_GLsizei)a[2], (w32gl_GLsizei*)w32gl_gptr(a[3]), (w32gl_GLint*)w32gl_gptr(a[4]), (w32gl_GLenum*)w32gl_gptr(a[5]), (w32gl_GLchar*)w32gl_gptr(a[6])); }
        break;
    case GL_FN_GETATTACHEDSHADERS:
        if (p_glGetAttachedShaders) { ((w32gl_PFN_glGetAttachedShaders)p_glGetAttachedShaders)((w32gl_GLuint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLsizei*)w32gl_gptr(a[2]), (w32gl_GLuint*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETATTRIBLOCATION:
        if (p_glGetAttribLocation) { *ret = (int64_t)(int32_t)((w32gl_PFN_glGetAttribLocation)p_glGetAttribLocation)((w32gl_GLuint)a[0], (const w32gl_GLchar*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETBOOLEANV:
        if (p_glGetBooleanv) { ((w32gl_PFN_glGetBooleanv)p_glGetBooleanv)((w32gl_GLenum)a[0], (w32gl_GLboolean*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETBUFFERPARAMETERIV:
        if (p_glGetBufferParameteriv) { ((w32gl_PFN_glGetBufferParameteriv)p_glGetBufferParameteriv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETERROR:
        if (p_glGetError) { *ret = (int64_t)(uint32_t)((w32gl_PFN_glGetError)p_glGetError)(); }
        break;
    case GL_FN_GETFLOATV:
        if (p_glGetFloatv) { ((w32gl_PFN_glGetFloatv)p_glGetFloatv)((w32gl_GLenum)a[0], (w32gl_GLfloat*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETFRAMEBUFFERATTACHMENTPARAMETERIV:
        if (p_glGetFramebufferAttachmentParameteriv) { ((w32gl_PFN_glGetFramebufferAttachmentParameteriv)p_glGetFramebufferAttachmentParameteriv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLenum)a[2], (w32gl_GLint*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETINTEGERV:
        if (p_glGetIntegerv) { ((w32gl_PFN_glGetIntegerv)p_glGetIntegerv)((w32gl_GLenum)a[0], (w32gl_GLint*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETPROGRAMIV:
        if (p_glGetProgramiv) { ((w32gl_PFN_glGetProgramiv)p_glGetProgramiv)((w32gl_GLuint)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETPROGRAMINFOLOG:
        if (p_glGetProgramInfoLog) { ((w32gl_PFN_glGetProgramInfoLog)p_glGetProgramInfoLog)((w32gl_GLuint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLsizei*)w32gl_gptr(a[2]), (w32gl_GLchar*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETRENDERBUFFERPARAMETERIV:
        if (p_glGetRenderbufferParameteriv) { ((w32gl_PFN_glGetRenderbufferParameteriv)p_glGetRenderbufferParameteriv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETSHADERIV:
        if (p_glGetShaderiv) { ((w32gl_PFN_glGetShaderiv)p_glGetShaderiv)((w32gl_GLuint)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETSHADERINFOLOG:
        if (p_glGetShaderInfoLog) { ((w32gl_PFN_glGetShaderInfoLog)p_glGetShaderInfoLog)((w32gl_GLuint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLsizei*)w32gl_gptr(a[2]), (w32gl_GLchar*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETSHADERPRECISIONFORMAT:
        if (p_glGetShaderPrecisionFormat) { ((w32gl_PFN_glGetShaderPrecisionFormat)p_glGetShaderPrecisionFormat)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2]), (w32gl_GLint*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETSHADERSOURCE:
        if (p_glGetShaderSource) { ((w32gl_PFN_glGetShaderSource)p_glGetShaderSource)((w32gl_GLuint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLsizei*)w32gl_gptr(a[2]), (w32gl_GLchar*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_GETSTRING:
        if (p_glGetString) { *ret = w32gl_string_out(a, (const char*)((w32gl_PFN_glGetString)p_glGetString)((w32gl_GLenum)a[0])); }
        break;
    case GL_FN_GETTEXPARAMETERFV:
        if (p_glGetTexParameterfv) { ((w32gl_PFN_glGetTexParameterfv)p_glGetTexParameterfv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETTEXPARAMETERIV:
        if (p_glGetTexParameteriv) { ((w32gl_PFN_glGetTexParameteriv)p_glGetTexParameteriv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETUNIFORMFV:
        if (p_glGetUniformfv) { ((w32gl_PFN_glGetUniformfv)p_glGetUniformfv)((w32gl_GLuint)a[0], (w32gl_GLint)a[1], (w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETUNIFORMIV:
        if (p_glGetUniformiv) { ((w32gl_PFN_glGetUniformiv)p_glGetUniformiv)((w32gl_GLuint)a[0], (w32gl_GLint)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETUNIFORMLOCATION:
        if (p_glGetUniformLocation) { *ret = (int64_t)(int32_t)((w32gl_PFN_glGetUniformLocation)p_glGetUniformLocation)((w32gl_GLuint)a[0], (const w32gl_GLchar*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_GETVERTEXATTRIBFV:
        if (p_glGetVertexAttribfv) { ((w32gl_PFN_glGetVertexAttribfv)p_glGetVertexAttribfv)((w32gl_GLuint)a[0], (w32gl_GLenum)a[1], (w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETVERTEXATTRIBIV:
        if (p_glGetVertexAttribiv) { ((w32gl_PFN_glGetVertexAttribiv)p_glGetVertexAttribiv)((w32gl_GLuint)a[0], (w32gl_GLenum)a[1], (w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_GETVERTEXATTRIBPOINTERV:
        if (p_glGetVertexAttribPointerv) { ((w32gl_PFN_glGetVertexAttribPointerv)p_glGetVertexAttribPointerv)((w32gl_GLuint)a[0], (w32gl_GLenum)a[1], (w32gl_void**)w32gl_gptr(a[2])); }
        break;
    case GL_FN_HINT:
    ...
    case GL_FN_READPIXELS:
        if (p_glReadPixels) { ((w32gl_PFN_glReadPixels)p_glReadPixels)((w32gl_GLint)a[0], (w32gl_GLint)a[1], (w32gl_GLsizei)a[2], (w32gl_GLsizei)a[3], (w32gl_GLenum)a[4], (w32gl_GLenum)a[5], (w32gl_void*)w32gl_gptr(a[6])); }
        break;
    ...
    case GL_FN_SHADERBINARY:
        if (p_glShaderBinary) { ((w32gl_PFN_glShaderBinary)p_glShaderBinary)((w32gl_GLsizei)a[0], (const w32gl_GLuint*)w32gl_gptr(a[1]), (w32gl_GLenum)a[2], (const w32gl_void*)w32gl_gptr(a[3]), (w32gl_GLsizei)a[4]); }
        break;
    case GL_FN_SHADERSOURCE:
        if (p_glShaderSource) { ((w32gl_PFN_glShaderSource)p_glShaderSource)((w32gl_GLuint)a[0], (w32gl_GLsizei)a[1], w32gl_translate_shader_srcs(a, (int)a[1]), (const w32gl_GLint*)w32gl_gptr(a[3])); }
        break;
    ...
    case GL_FN_TEXIMAGE2D:
        if (p_glTexImage2D) { ((w32gl_PFN_glTexImage2D)p_glTexImage2D)((w32gl_GLenum)a[0], (w32gl_GLint)a[1], (w32gl_GLint)a[2], (w32gl_GLsizei)a[3], (w32gl_GLsizei)a[4], (w32gl_GLint)a[5], (w32gl_GLenum)a[6], (w32gl_GLenum)a[7], (const w32gl_void*)w32gl_gptr(a[8])); }
        break;
    ...
    case GL_FN_TEXPARAMETERFV:
        if (p_glTexParameterfv) { ((w32gl_PFN_glTexParameterfv)p_glTexParameterfv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (const w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_TEXPARAMETERIV:
        if (p_glTexParameteriv) { ((w32gl_PFN_glTexParameteriv)p_glTexParameteriv)((w32gl_GLenum)a[0], (w32gl_GLenum)a[1], (const w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_TEXSUBIMAGE2D:
        if (p_glTexSubImage2D) { ((w32gl_PFN_glTexSubImage2D)p_glTexSubImage2D)((w32gl_GLenum)a[0], (w32gl_GLint)a[1], (w32gl_GLint)a[2], (w32gl_GLint)a[3], (w32gl_GLsizei)a[4], (w32gl_GLsizei)a[5], (w32gl_GLenum)a[6], (w32gl_GLenum)a[7], (const w32gl_void*)w32gl_gptr(a[8])); }
        break;
    ...
    case GL_FN_UNIFORM1FV:
        if (p_glUniform1fv) { ((w32gl_PFN_glUniform1fv)p_glUniform1fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM1IV:
        if (p_glUniform1iv) { ((w32gl_PFN_glUniform1iv)p_glUniform1iv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM2FV:
        if (p_glUniform2fv) { ((w32gl_PFN_glUniform2fv)p_glUniform2fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM2IV:
        if (p_glUniform2iv) { ((w32gl_PFN_glUniform2iv)p_glUniform2iv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM3FV:
        if (p_glUniform3fv) { ((w32gl_PFN_glUniform3fv)p_glUniform3fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM3IV:
        if (p_glUniform3iv) { ((w32gl_PFN_glUniform3iv)p_glUniform3iv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM4FV:
        if (p_glUniform4fv) { ((w32gl_PFN_glUniform4fv)p_glUniform4fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLfloat*)w32gl_gptr(a[2])); }
        break;
    ...
    case GL_FN_UNIFORM4IV:
        if (p_glUniform4iv) { ((w32gl_PFN_glUniform4iv)p_glUniform4iv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (const w32gl_GLint*)w32gl_gptr(a[2])); }
        break;
    case GL_FN_UNIFORMMATRIX2FV:
        if (p_glUniformMatrix2fv) { ((w32gl_PFN_glUniformMatrix2fv)p_glUniformMatrix2fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLboolean)a[2], (const w32gl_GLfloat*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_UNIFORMMATRIX3FV:
        if (p_glUniformMatrix3fv) { ((w32gl_PFN_glUniformMatrix3fv)p_glUniformMatrix3fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLboolean)a[2], (const w32gl_GLfloat*)w32gl_gptr(a[3])); }
        break;
    case GL_FN_UNIFORMMATRIX4FV:
        if (p_glUniformMatrix4fv) { ((w32gl_PFN_glUniformMatrix4fv)p_glUniformMatrix4fv)((w32gl_GLint)a[0], (w32gl_GLsizei)a[1], (w32gl_GLboolean)a[2], (const w32gl_GLfloat*)w32gl_gptr(a[3])); }
        break;
    ...
    case GL_FN_VERTEXATTRIB1FV:
        if (p_glVertexAttrib1fv) { ((w32gl_PFN_glVertexAttrib1fv)p_glVertexAttrib1fv)((w32gl_GLuint)a[0], (const w32gl_GLfloat*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_VERTEXATTRIB2FV:
        if (p_glVertexAttrib2fv) { ((w32gl_PFN_glVertexAttrib2fv)p_glVertexAttrib2fv)((w32gl_GLuint)a[0], (const w32gl_GLfloat*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_VERTEXATTRIB3FV:
        if (p_glVertexAttrib3fv) { ((w32gl_PFN_glVertexAttrib3fv)p_glVertexAttrib3fv)((w32gl_GLuint)a[0], (const w32gl_GLfloat*)w32gl_gptr(a[1])); }
        break;
    ...
    case GL_FN_VERTEXATTRIB4FV:
        if (p_glVertexAttrib4fv) { ((w32gl_PFN_glVertexAttrib4fv)p_glVertexAttrib4fv)((w32gl_GLuint)a[0], (const w32gl_GLfloat*)w32gl_gptr(a[1])); }
        break;
    case GL_FN_VERTEXATTRIBPOINTER:
        if (p_glVertexAttribPointer) { ((w32gl_PFN_glVertexAttribPointer)p_glVertexAttribPointer)((w32gl_GLuint)a[0], (w32gl_GLint)a[1], (w32gl_GLenum)a[2], (w32gl_GLboolean)a[3], (w32gl_GLsizei)a[4], (const w32gl_void*)w32gl_gptr_or_off(a[5])); }
        break;
    case GL_FN_VIEWPORT:
